<head>
    ...
    <title>BG Logistics Driver App</title>
    ...
    <link href="{{ asset('css/mobile/style.css') }}" rel="stylesheet" id="style">
    <link href="{{ asset('css/mobile/login.css') }}" rel="stylesheet" id="style">
</head>
