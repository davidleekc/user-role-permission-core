...
@section('title') List Shipments @endsection

@section('breadcrumbs')
<x-backend-breadcrumbs>
    <x-backend-breadcrumb-item type="active" icon='c-icon cil-people'>Shipments</x-backend-breadcrumb-item>
</x-backend-breadcrumbs>
@endsection
                            ...
                            <ul class="list-group list-group-flush bg-none">
                                ...
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-auto">
                                            <div class="avatar avatar-60 shadow-sm card rounded-15 p-1">
                                                <img src="assets/img/company5.png" alt="" class="rounded-15">
                                            </div>
                                        </div>
                                        <div class="col align-self-center ps-0">
                                ...
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-auto">
                                            <div class="avatar avatar-60 shadow-sm card rounded-15 p-1">
                                                <img src="assets/img/company2.png" alt="" class="rounded-15">
                                            </div>
                                        </div>
                                        <div class="col align-self-center ps-0">
                                            <p class="text-secondary size-10 mb-0">Food</p>
                                ...
                                <li class="list-group-item">
                                    <div class="row">
                                        <div class="col-auto">
                                            <div class="avatar avatar-60 shadow-sm card rounded-15 p-1">
                                                <img src="assets/img/company3.jpg" alt="" class="rounded-15">
                                            </div>
                                        </div>
                                        <div class="col align-self-center ps-0">
