...
$.dore = function (element, options) {
  ...
  function init() {
	...
	var monthly = ["Jan", "Feb", "Mar", "Apr", "May", "Jun"];
	var yValues = [];
	var yValues2 = [];
	
	if (document.getElementById("OrderTotal")) {
		yValues = [$("#OrderDataWeek_1").attr('value'), $("#OrderDataWeek_2").attr('value'), $("#OrderDataWeek_3").attr('value'), $("#OrderDataWeek_4").attr('value'), $("#OrderDataWeek_5").attr('value'), $("#OrderDataWeek_6").attr('value'), $("#OrderDataWeek_7").attr('value')];
		orderChart = document.getElementById("OrderTotal").getContext("2d");
		OrderTotalChart = new Chart(orderChart, {
			type: "LineWithShadow",
			options: {
				plugins: {
					datalabels: {
	...
	$('#OrderTotalMonth').click(function() {
		yValues = [$("#OrderDataMonth_1").attr('value'), $("#OrderDataMonth_2").attr('value'), $("#OrderDataMonth_3").attr('value'), $("#OrderDataMonth_4").attr('value'), $("#OrderDataMonth_5").attr('value'), $("#OrderDataMonth_6").attr('value')];
		OrderTotalChart.data.datasets[0].data = yValues;
		OrderTotalChart.data.labels = monthly;
		OrderTotalChart.update();
	});
	$('#OrderTotalWeek').click(function() {
		yValues = [$("#OrderDataWeek_1").attr('value'), $("#OrderDataWeek_2").attr('value'), $("#OrderDataWeek_3").attr('value'), $("#OrderDataWeek_4").attr('value'), $("#OrderDataWeek_5").attr('value'), $("#OrderDataWeek_6").attr('value'), $("#OrderDataWeek_7").attr('value')];
		OrderTotalChart.data.datasets[0].data = yValues;
		OrderTotalChart.data.labels = weekly;
		OrderTotalChart.update();
	});
	
	if (document.getElementById("RevenueTotal")) {
		yValues = [$("#RevenueDataWeek_1").attr('value'), $("#RevenueDataWeek_2").attr('value'), $("#RevenueDataWeek_3").attr('value'), $("#RevenueDataWeek_4").attr('value'), $("#RevenueDataWeek_5").attr('value'), $("#RevenueDataWeek_6").attr('value'), $("#RevenueDataWeek_7").attr('value')];
		revenueChart = document.getElementById("RevenueTotal").getContext("2d");
		RevenueTotalChart = new Chart(revenueChart, {
			type: "LineWithShadow",
			options: {
				plugins: {
					datalabels: {
	...
	$('#TotalRevenueMonth').click(function() {
		yValues = [$("#RevenueDataMonth_1").attr('value'), $("#RevenueDataMonth_2").attr('value'), $("#RevenueDataMonth_3").attr('value'), $("#RevenueDataMonth_4").attr('value'), $("#RevenueDataMonth_5").attr('value'), $("#RevenueDataMonth_6").attr('value')];
		RevenueTotalChart.data.datasets[0].data = yValues;
		RevenueTotalChart.options.scales.yAxes[0].ticks.max = 100000;
		RevenueTotalChart.options.scales.yAxes[0].ticks.stepSize = 20000;
		RevenueTotalChart.data.labels = monthly;
		RevenueTotalChart.update();
	});
	$('#TotalRevenueWeek').click(function() {
		yValues = [$("#RevenueDataWeek_1").attr('value'), $("#RevenueDataWeek_2").attr('value'), $("#RevenueDataWeek_3").attr('value'), $("#RevenueDataWeek_4").attr('value'), $("#RevenueDataWeek_5").attr('value'), $("#RevenueDataWeek_6").attr('value'), $("#RevenueDataWeek_7").attr('value')];
		RevenueTotalChart.options.scales.yAxes[0].ticks.max = 10000;
		RevenueTotalChart.options.scales.yAxes[0].ticks.stepSize = 2000;
		RevenueTotalChart.data.datasets[0].data = yValues;
		RevenueTotalChart.data.labels = weekly;
		RevenueTotalChart.update();
	});

	if (document.getElementById("OrderSummaryPie")) {
		var checkData = 0;
		$.ajaxSetup({
			headers: {
		...
		$.ajax({  //create an ajax request to display.php
			type: "GET",
			url: "https://logistics.itoweb.online/admin/chart",
			data: {"checkData":1},
				...
				var myDoughnutChart = new Chart(categoryChartNoShadow, {
					...
					data: {
						...
						datasets: [
							{
								label: "",
								borderColor: [themeColor3, themeColor2],
								backgroundColor: [
									themeColor3_10,
									themeColor2_10
								],
								borderWidth: 2,
								data: [approved, reject]
							}
						]
					},
					draw: function () { },
	...
	if (document.getElementById("OrderSummaryChart")) {
		yValues = [$("#ApproveDataWeek_1").attr('value'), $("#ApproveDataWeek_2").attr('value'), $("#ApproveDataWeek_3").attr('value'), $("#RevenueDataWeek_4").attr('value'), $("#ApproveDataWeek_5").attr('value'), $("#ApproveDataWeek_6").attr('value'), $("#ApproveDataWeek_7").attr('value')];
		yValues2 = [$("#RejectDataWeek_1").attr('value'), $("#RejectDataWeek_2").attr('value'), $("#RejectDataWeek_3").attr('value'), $("#RejectDataWeek_4").attr('value'), $("#RejectDataWeek_5").attr('value'), $("#RejectDataWeek_6").attr('value'), $("#RejectDataWeek_7").attr('value')];
		var productChartNoShadow = document
			.getElementById("OrderSummaryChart")
			.getContext("2d");
		var OrderSummaryChart = new Chart(productChartNoShadow, {
			type: "bar",
			options: {
				plugins: {
					datalabels: {
	...
	$('#OrderSummaryMonth').click(function() {
		yValues = [$("#ApproveDataMonth_1").attr('value'), $("#ApproveDataMonth_2").attr('value'), $("#ApproveDataMonth_3").attr('value'), $("#ApproveDataMonth_4").attr('value'), $("#ApproveDataMonth_5").attr('value'), $("#ApproveDataMonth_6").attr('value')];
		yValues2 = [$("#RejectDataMonth_1").attr('value'), $("#RejectDataMonth_2").attr('value'), $("#RejectDataMonth_3").attr('value'), $("#RejectDataMonth_4").attr('value'), $("#RejectDataMonth_5").attr('value'), $("#RejectDataMonth_6").attr('value')];
		OrderSummaryChart.data.datasets[0].data = yValues;
		OrderSummaryChart.data.datasets[1].data = yValues2;
		OrderSummaryChart.data.labels = monthly;
		OrderSummaryChart.update();
	});
	$('#OrderSummaryWeek').click(function() {
		yValues = [$("#ApproveDataWeek_1").attr('value'), $("#ApproveDataWeek_2").attr('value'), $("#ApproveDataWeek_3").attr('value'), $("#ApproveDataWeek_4").attr('value'), $("#ApproveDataWeek_5").attr('value'), $("#ApproveDataWeek_6").attr('value')];
		yValues2 = [$("#RejectDataWeek_1").attr('value'), $("#RejectDataWeek_2").attr('value'), $("#RejectDataWeek_3").attr('value'), $("#RejectDataWeek_4").attr('value'), $("#RejectDataWeek_5").attr('value'), $("#RejectDataWeek_6").attr('value')];
		OrderSummaryChart.data.datasets[0].data = yValues;
		OrderSummaryChart.data.datasets[1].data = yValues2;
		OrderSummaryChart.data.labels = weekly;
		OrderSummaryChart.update();
	});

	if (document.getElementById("TopServicesPie")) {
		$.ajaxSetup({
			headers: {
				'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
			}
		...
		$.ajax({  //create an ajax request to display.php
			...
			success: function (data) {
				...
				var pieChart = document.getElementById("TopServicesPie");
				var myChart = new Chart(pieChart, {
					plugins: [centerTextPlugin],
                    type: "doughnut",
					data: {
						labels: ["House Moving", "Office Moving", "Disposal", "Parcel Delivery"],
						datasets: [
							{
								label: "",
								...
								borderWidth: 2,
								data: [house, office, disposal, parcel]
							}
						]
					},
					draw: function () { },
	...
	if (document.getElementById("TopServicesChart")) {
		yValues = [$("#HouseDataWeek_1").attr('value'), $("#HouseDataWeek_2").attr('value'), $("#HouseDataWeek_3").attr('value'), $("#HouseDataWeek_4").attr('value'), $("#HouseDataWeek_5").attr('value'), $("#HouseDataWeek_6").attr('value'), $("#HouseDataWeek_7").attr('value')];
		yValues2 = [$("#OfficeDataWeek_1").attr('value'), $("#OfficeDataWeek_2").attr('value'), $("#OfficeDataWeek_3").attr('value'), $("#OfficeDataWeek_4").attr('value'), $("#OfficeDataWeek_5").attr('value'), $("#OfficeDataWeek_6").attr('value'), $("#OfficeDataWeek_7").attr('value')];
		var yValues3 = [$("#DisposalDataWeek_1").attr('value'), $("#DisposalDataWeek_2").attr('value'), $("#DisposalDataWeek_3").attr('value'), $("#DisposalDataWeek_4").attr('value'), $("#DisposalDataWeek_5").attr('value'), $("#DisposalDataWeek_6").attr('value'), $("#DisposalDataWeek_7").attr('value')];
		var yValues4 = [$("#ParcelDataWeek_1").attr('value'), $("#ParcelDataWeek_2").attr('value'), $("#ParcelDataWeek_3").attr('value'), $("#ParcelDataWeek_4").attr('value'), $("#ParcelDataWeek_5").attr('value'), $("#ParcelDataWeek_6").attr('value'), $("#ParcelDataWeek_7").attr('value')];
		var productChartNoShadow = document
			.getElementById("TopServicesChart")
			.getContext("2d");
		var servicesChart = new Chart(productChartNoShadow, {
			type: "bar",
			options: {
				plugins: {
					datalabels: {
	...
	$('#TopServicesMonth').click(function() {
		yValues = [$("#HouseDataMonth_1").attr('value'), $("#HouseDataMonth_2").attr('value'), $("#HouseDataMonth_3").attr('value'), $("#HouseDataMonth_4").attr('value'), $("#HouseDataMonth_5").attr('value'), $("#HouseDataMonth_6").attr('value')];
		yValues2 = [$("#OfficeDataMonth_1").attr('value'), $("#OfficeDataMonth_2").attr('value'), $("#OfficeDataMonth_3").attr('value'), $("#OfficeDataMonth_4").attr('value'), $("#OfficeDataMonth_5").attr('value'), $("#OfficeDataMonth_6").attr('value')];
		yValues3 = [$("#DisposalDataMonth_1").attr('value'), $("#DisposalDataMonth_2").attr('value'), $("#DisposalDataMonth_3").attr('value'), $("#DisposalDataMonth_4").attr('value'), $("#DisposalDataMonth_5").attr('value'), $("#DisposalDataMonth_6").attr('value')];
		yValues4 = [$("#ParcelDataMonth_1").attr('value'), $("#ParcelDataMonth_2").attr('value'), $("#ParcelDataMonth_3").attr('value'), $("#ParcelDataMonth_4").attr('value'), $("#ParcelDataMonth_5").attr('value'), $("#ParcelDataMonth_6").attr('value')];
		servicesChart.data.datasets[0].data = yValues;
		servicesChart.data.datasets[1].data = yValues2;
		servicesChart.data.datasets[2].data = yValues3;
		servicesChart.data.datasets[3].data = yValues4;
		servicesChart.data.labels = monthly;
		servicesChart.update();
	});
	$('#TopServicesWeek').click(function() {
		yValues = [$("#HouseDataWeek_1").attr('value'), $("#HouseDataWeek_2").attr('value'), $("#HouseDataWeek_3").attr('value'), $("#HouseDataWeek_4").attr('value'), $("#HouseDataWeek_5").attr('value'), $("#HouseDataWeek_6").attr('value'), $("#HouseDataWeek_7").attr('value')];
		yValues2 = [$("#OfficeDataWeek_1").attr('value'), $("#OfficeDataWeek_2").attr('value'), $("#OfficeDataWeek_3").attr('value'), $("#OfficeDataWeek_4").attr('value'), $("#OfficeDataWeek_5").attr('value'), $("#OfficeDataWeek_6").attr('value'), $("#OfficeDataWeek_7").attr('value')];
		yValues3 = [$("#DisposalDataWeek_1").attr('value'), $("#DisposalDataWeek_2").attr('value'), $("#DisposalDataWeek_3").attr('value'), $("#DisposalDataWeek_4").attr('value'), $("#DisposalDataWeek_5").attr('value'), $("#DisposalDataWeek_6").attr('value'), $("#DisposalDataWeek_7").attr('value')];
		yValues4 = [$("#ParcelDataWeek_1").attr('value'), $("#ParcelDataWeek_2").attr('value'), $("#ParcelDataWeek_3").attr('value'), $("#ParcelDataWeek_4").attr('value'), $("#ParcelDataWeek_5").attr('value'), $("#ParcelDataWeek_6").attr('value'), $("#ParcelDataWeek_7").attr('value')];
		servicesChart.data.datasets[0].data = yValues;
		servicesChart.data.datasets[1].data = yValues2;
		servicesChart.data.datasets[2].data = yValues3;
		servicesChart.data.datasets[3].data = yValues4;
		servicesChart.data.labels = weekly;
		servicesChart.update();
	});

    if (document.getElementById("ShipmentSummaryPie")) {
		var checkData = 2;
		$.ajaxSetup({
			headers: {
				'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
		...
		$.ajax({  //create an ajax request to display.php
			...
			success: function (data) {
				...
				for (i = 0; i < data.length; i++){
					if (i == 0) {
						var completed = data[i];
					}else{
						var cancelled = data[i];
					}
				}
				 var categoryChartNoShadow = document.getElementById(
					"ShipmentSummaryPie"
	...
	if (document.getElementById("ShipmentSummaryChart")) {
		yValues = [$("#CompletedDataWeek_1").attr('value'), $("#CompletedDataWeek_2").attr('value'), $("#CompletedDataWeek_3").attr('value'), $("#CompletedDataWeek_4").attr('value'), $("#CompletedDataWeek_5").attr('value'), $("#CompletedDataWeek_6").attr('value'), $("#CompletedDataWeek_7").attr('value')];
		yValues2 = [$("#CancelledDataWeek_1").attr('value'), $("#CancelledDataWeek_2").attr('value'), $("#CancelledDataWeek_3").attr('value'), $("#CancelledDataWeek_4").attr('value'), $("#CancelledDataWeek_5").attr('value'), $("#CancelledDataWeek_6").attr('value'), $("#CancelledDataWeek_7").attr('value')];
		var productChartNoShadow = document
			.getElementById("ShipmentSummaryChart")
			.getContext("2d");
		var ShipmentSummaryChart = new Chart(productChartNoShadow, {
			type: "bar",
			options: {
				plugins: {
					datalabels: {
	...
	$('#ShipmentSummaryMonth').click(function() {
		yValues = [$("#CompletedDataMonth_1").attr('value'), $("#CompletedDataMonth_2").attr('value'), $("#CompletedDataMonth_3").attr('value'), $("#CompletedDataMonth_4").attr('value'), $("#CompletedDataMonth_5").attr('value'), $("#CompletedDataMonth_6").attr('value')];
		yValues2 = [$("#CancelledDataMonth_1").attr('value'), $("#CancelledDataMonth_2").attr('value'), $("#CancelledDataMonth_3").attr('value'), $("#CancelledDataMonth_4").attr('value'), $("#CancelledDataMonth_5").attr('value'), $("#CancelledDataMonth_6").attr('value')];
		ShipmentSummaryChart.data.datasets[0].data = yValues;
		ShipmentSummaryChart.data.datasets[1].data = yValues2;
		ShipmentSummaryChart.data.labels = monthly;
		ShipmentSummaryChart.update();
	});
	$('#ShipmentSummaryWeek').click(function() {
		yValues = [$("#CompletedDataWeek_1").attr('value'), $("#CompletedDataWeek_2").attr('value'), $("#CompletedDataWeek_3").attr('value'), $("#CompletedDataWeek_4").attr('value'), $("#CompletedDataWeek_5").attr('value'), $("#CompletedDataWeek_6").attr('value'), $("#CompletedDataWeek_7").attr('value')];
		yValues2 = [$("#CancelledDataWeek_1").attr('value'), $("#CancelledDataWeek_2").attr('value'), $("#CancelledDataWeek_3").attr('value'), $("#CancelledDataWeek_4").attr('value'), $("#CancelledDataWeek_5").attr('value'), $("#CancelledDataWeek_6").attr('value'), $("#CancelledDataWeek_7").attr('value')];
		ShipmentSummaryChart.data.datasets[0].data = yValues;
		ShipmentSummaryChart.data.datasets[1].data = yValues2;
		ShipmentSummaryChart.data.labels = weekly;
		ShipmentSummaryChart.update();
	});
